...
{{$post->content}}
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-content">
                        <div class="author-info">
                            ...
                            <p class="author-info">Web Developer</p>
                        </div>
                ...
                <div class="pagination-arrow">
                   ...
                   @if($next)
                    <a href="{{route('post_single',['id' =>  $next->id ] ) }}" class="btn-prev-wrap">
                        <svg class="btn-prev">
                   ...
                   @endif
                   @if($prev)
                    <a href="{{route('post_single',['id' =>  $prev->id ] ) }}" class="btn-next-wrap">
                        <div class="btn-content">
            ...
            <div class="col-lg-12">
                <aside aria-label="sidebar" class="sidebar sidebar-right">
                    <div  class="widget w-tags">
                        ...
                        <div class="tags-wrap">
                            @foreach($tags as $tag)
                            <a href="{{route('tag_single', ['id' => $tag->id])}}" class="w-tags-item">{{$tag->name}}</a>
                            @endforeach
                        </div>
                    </div>
                </aside>
